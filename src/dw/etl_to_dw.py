...
def load_data_to_db() -> None:
    ...
    try:
        ...
        #     r"C:\Users\caleb\Documents\School\NWMSU MSDS\44632\smart-store-calebsellinger\data\prepared"
        # )
        # logger.info("Yay")

        # Load prepared data using pandas
        # customers_df = pd.read_csv(r'C:\Users\caleb\Documents\School\NWMSU MSDS\44632\smart-store-calebsellinger\data\prepared\customers_prepared.csv')
